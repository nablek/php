	...
	<html>
  	...
  	<body>
		...
		<form  action="conf_base_business.php" method="post" enctype="multipart/form-data">
	  	<table class="sample-table">
	    	<!-- カテゴリ分けのプルダウンボタン -->
	    	<p>
	      	<select name="category" id="category" autofocus required aria-required="true" x-moz-errormessage="カテゴリが未選択です">
