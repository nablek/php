	...
	<!-- actionのところのphpファイル名は確認画面のphpである「conf_business.php」に設定 -->
		<form  action="conf_event_business.php" name="busi_form" method="post" enctype="multipart/form-data" onSubmit="return form_check()">
			...
			<table class="sample-table">
				...
				<tr>
				<th>開催日程</th>
				<td><input type="text" name="event_date" size="30"  autofocus required aria-required="true" x-moz-errormessage="開催日程が未記入です" placeholder=" 0月00日~0月00日 0:00~0:00" value="<?php echo $_POST["event_date"] ?>">
				</td>
				</tr>
