...
<!-- actionのところのphpファイル名は確認画面のphpである「confirm.php」に設定 -->
  <form  action="confirm.php" name="event_form" method="post" enctype="multipart/form-data" onSubmit="return form_check()">
    <table class="sample-table">
		...
		<td><input type="text" autofocus required  name="event_name" size="30" value="<?php echo $_POST["event_name"] ?>">
		</td>
		</tr>
		...
		<tr>
		<th>開催日程</th>
		<td><input type="text" autofocus required  name="event_date" size="30" placeholder=" 0月00日~0月00日 0:00~0:00" value="<?php echo $_POST["event_date"] ?>">
		</td>
		</tr>
		...
		<tr>
		<th>場所(住所)</th>
		<td><input type="text" autofocus required  name="event_place" size="30" value="<?php echo $_POST["event_place"] ?>">  
		</td>
		</tr>
		...
		<tr>
		<th>内容</th>
        <td><textarea rows="10" cols="50" autofocus required  name="content"><?php echo $_POST["content"] ?></textarea></td>
		</tr>
  </table>
